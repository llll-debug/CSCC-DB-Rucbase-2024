...
class ProjectionPlan : public Plan {
 public:
  ProjectionPlan(PlanTag tag, std::shared_ptr<Plan> subplan,
                 std::vector<TabCol> sel_cols, std::vector<std::string> alias,
                 int limit = -1) {
    Plan::tag = tag;
...
class StaticCheckpointPlan : public Plan {
 public:
  StaticCheckpointPlan(PlanTag tag) { Plan::tag = tag; }
